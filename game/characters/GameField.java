...
public class GameField {
    ...
    private void createMonster(int type){
        ...
        monsterGroup.getChildren().add(gameState.getMonstersAlive().get(gameState.getMonstersAlive().size() - 1).getmonster());
    }
    ...
    private synchronized void removeMonster(Monster monster){
        ...
        monster.getmonster().setVisible(false);
